...
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color, size) VALUES('Polo Shirt', 'Benetton Men  Classic Fit Polo Shirt',511, 10, 5, 1 ,'Polo','Sky Blue', 'Medium');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color, size) VALUES('Wrangler', 'Men  Slim Fit Jeans', 600, 20, 5, 1 , 'Armani','Charcoal Black','Large');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color, size) VALUES('Dragon Jacket','Made from the skin of one of the dragons', 700, 40, 5, 1 ,'Veteran','Black','Extra Large');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES('HD Ready Android LED TV ', 'Resolution: HD Ready Android TV (1366x768)', 1200, 20, 10, 2 ,'Samsung','Black');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES('Sony DSC W830 Cyber-Shot 20.1 MP ', 'Shoot Camera (Black) with 8X ', 1500, 50, 15, 2 , 'Samsung','Blue');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES('Charger', 'Mi 10W Charger with Cable (1.2 Meter, Black)', 500, 5, 0, 2 ,'One Plus','White');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES('Apple iPhone 11 Pro (64GB)', '5.8-inch (14.7 cm) ', 60000, 5, 10, 3 ,'Apple', 'Golden');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES('Apple iPhone 11 Pro (64GB) Max', '5.8-inch (14.7 cm) ', 700000, 4, 30, 3, 'Apple','Black' );
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES('Apple iPhone XR (64GB)', '6.1-inch (15.5 cm) Liquid Retina HD LCD display', 50000, 6, 20, 3, 'Apple','Grey' );
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES ('Rolex Watch','by wearing it you are bound to feel realaxed',2100, 10, 10, 4, 'Rolex', 'Blue');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES ('Titan Watch','With the look of and feel of old days',2000, 15, 8, 4 ,'Titan','Ocean Blue');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color) VALUES ('Sonata Watch','Stylished belts and longer battery',3010, 20, 12, 4 ,'Sonata','Golden');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand) VALUES ('Wings of Fire','autobiography by visionary scientist',332, 10, 5, 5, 'TechMax Publications');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand) VALUES ('Thoughts to Inspire','famous quotes by Swami Vivekananda', 150, 15, 10, 5, 'Technical Publications' );
INSERT INTO products (name, description, price, discount, quantity, category_id, brand, color, size) VALUES ('Lancer','Mens Running Shoes', 150, 15, 10, 6 , 'Nike', 'Red', 'Small');
INSERT INTO products (name, description, price, discount, quantity, category_id, brand) VALUES ('Football','Sporting Goods', 200, 40, 15, 6, 'Cosco' );
